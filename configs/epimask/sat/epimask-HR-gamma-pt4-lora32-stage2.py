...
cfg.EPIMASK.RESOLUTION = [4, 2]
cfg.EPIMASK.COARSE.D_MODEL = 128
...
# gamma (EPI_DIST_THR_REDUCTION_FACTOR) below is 0.4 to match the released
# EpiMask-HR gamma=0.4 checkpoint (model_weights/epimask-HR-gamma-pt4-lora32-stage2/);
# set it to 0.6 to instead train/reproduce the gamma=0.6 variant.
cfg.EPIMASK.COARSE.EPI_DIST_THR_START = 168
cfg.EPIMASK.COARSE.EPI_DIST_THR_REDUCTION_FACTOR = 0.4
